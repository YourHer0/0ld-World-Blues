...
/obj/item/weapon/melee/cultblade/attack(mob/living/M, mob/living/user, var/target_zone)
	...
	var/zone = (user.hand ? BP_L_HAND:BP_R_HAND)
	if(ishuman(user))
		var/mob/living/carbon/human/H = user
		var/obj/item/organ/external/affecting = H.get_organ(zone)
		user << SPAN_DANG("An unexplicable force rips through your [affecting.name], tearing the sword from your grasp!")
	else
		user << SPAN_DANG("An unexplicable force rips through you, tearing the sword from your grasp!")
