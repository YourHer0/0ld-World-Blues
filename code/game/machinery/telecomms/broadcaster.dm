...
/obj/machinery/telecomms/broadcaster
	...
	produces_heat = 0
	delay = 7
	circuitboard = /obj/item/weapon/circuitboard/machinery/broadcaster
  ...
  /* ###### Organize the receivers into categories for displaying the message ###### */
	...
	for (var/mob/R in receive)
	  ...
	  /* --- Loop through the receivers and categorize them --- */
		...
		if(data == 3 && isobserver(R) && R.client && R.client.prefs && (R.client.prefs.chat_toggles & CHAT_GHOSTRADIO))
			continue
