...
/obj/item/weapon/reagent_containers/rag/New()
	..()
	update_name()
...
/obj/item/weapon/reagent_containers/rag/attackby(obj/item/W, mob/user)
...
/obj/item/weapon/reagent_containers/rag/proc/update_name()
	if(on_fire)
...
/obj/item/weapon/reagent_containers/rag/update_icon()
	if(on_fire)
		icon_state = "raglit"
	else
		icon_state = "rag"

	var/obj/item/weapon/reagent_containers/glass/drinks/bottle/B = loc
	if(istype(B))
		B.update_icon()

/obj/item/weapon/reagent_containers/rag/proc/remove_contents(mob/user, atom/trans_dest = null)
...
/obj/item/weapon/reagent_containers/rag/fire_act(datum/gas_mixture/air, exposed_temperature, exposed_volume)
...
/obj/item/weapon/reagent_containers/rag/proc/can_ignite()
	var/fuel
...
/obj/item/weapon/reagent_containers/rag/proc/ignite()
	if(on_fire)
		return
	if(!can_ignite())
		return
