...
/mob/living/carbon/slime/blob_act()
	...
	show_message(SPAN_DANG(" The blob attacks you!"))
		...
		if (I_GRAB)
			...
			if (prob(90))
				...
				*/
				...
				playsound(loc, 'sound/weapons/punchmiss.ogg', 25, 1, -1)
				visible_message(SPAN_DANG("[M] has attempted to punch [src]!"))
	return
...
/mob/living/carbon/slime/attackby(obj/item/W, mob/user)
	if(W.force > 0)
		attacked += 10
		if(prob(25))
			user << SPAN_DANG("[W] passes right through [src]!")
			return
