/mob/living/simple_animal/borer/verb/release_host()
	...
	spawn(100)
		...
		if(host.mind)
			if(!host.stat)
				host << SPAN_DANG("Something slimy wiggles out of your ear and plops to the ground!")
			host << SPAN_DANG("As though waking from a dream, you shake off the insidious mind control of the brain worm. Your thoughts are your own again.")
