	...
	activate(var/mob/living/carbon/mob,var/multiplier)
		if(ishuman(mob))
			...
			if (!(E.status & ORGAN_DEAD))
				E.status |= ORGAN_DEAD
				H << SPAN_NOTE("You can't feel your [E.name] anymore...")
...
/datum/disease2/effect/immortal
	...
	deactivate(var/mob/living/carbon/mob,var/multiplier)
		if(ishuman(mob))
			var/mob/living/carbon/human/H = mob
			H << SPAN_NOTE("You suddenly feel hurt and old...")
			H.age += 8
...
/datum/disease2/effect/confusion
	...
	stage = 3
	activate(var/mob/living/carbon/mob,var/multiplier)
		mob << SPAN_NOTE("You have trouble telling right and left apart all of a sudden.")
		mob.confused += 10
	...
	activate(var/mob/living/carbon/mob,var/multiplier)
		if(ishuman(mob))
			...
			if(H.species.name == SPECIES_HUMAN && !(H.h_style == "Bald") && !(H.h_style == "Balding Hair"))
				H << SPAN_DANG("Your hair starts to fall out in clumps...")
				spawn(50)
...
/datum/disease2/effect/stimulant
	...
	stage = 2
	activate(var/mob/living/carbon/mob,var/multiplier)
		mob << SPAN_NOTE("You feel a rush of energy inside you!")
