...
/datum/reagent/nutriment/mix_data(var/list/newdata, var/newamount)
	...
	var/min_taste = totalFlavor/10
	for(var/taste in data)
		if(data[taste] < min_taste)
			data -= taste
...
/datum/reagent/capsaicin/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed)
	...
	if(dose < agony_dose)
		if(prob(5) || dose == metabolism) //dose == metabolism is a very hacky way of forcing the message the first time this procs
			M << SPAN_DANG(discomfort_message)
	else
		M.apply_effect(agony_amount, AGONY, 0)
		if(prob(5))
			M.custom_emote(2, "[pick("dry heaves!","coughs!","splutters!")]")
			M << SPAN_DANG("You feel like your insides are burning!")
	if(isslime(M))
...
/datum/reagent/capsaicin/condensed/affect_touch(var/mob/living/carbon/M, var/alien, var/removed)
	...
	if(mouth_covered)
		...
		message = SPAN_DANG("Your face and throat burn!")
		if(prob(25))
...
/datum/reagent/condensedcapsaicin/affect_ingest(var/mob/living/carbon/M, var/alien, var/removed)
	...
	if(dose == metabolism)
		...
		if(prob(5))
			M.visible_message(
				SPAN_WARN("[M] [pick("dry heaves!","coughs!","splutters!")]"),
				SPAN_DANG("You feel like your insides are burning!")
			)
	if(isslime(M))
...
/datum/reagent/ethanol/bananahonk
	...
	taste_description = "a bad joke with banana flavor"
	nutriment_factor = 1
	color = "#FFFF91"
	strength = 12
...
/datum/reagent/ethanol/whiskeysoda
	name = "Whiskey Soda"
	id = "whiskeysoda"
	taste_description = "carbonised whiskey"
...
/datum/reagent/ethanol/specialwhiskey // I have no idea what this is and where it comes from
	...
	taste_description = "the whiskey gods nectar"
	color = "#664300"
	strength = 25
